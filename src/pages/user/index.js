...
export default function User() {
  ...
  return (
    <>
      <S.Container>
        <S.Card>
          <S.Img src={gitData && gitData ? gitData.avatar_url : 'Não possui'} alt="Avatar"></S.Img>
          <S.Header>
            <S.Name>{ gitData && gitData ? gitData.name : 'Não possui'}</S.Name>
            <S.ExpandMore onClick={expand}>
